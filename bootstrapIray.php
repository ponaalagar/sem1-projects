...
<link rel="stylesheet" href="testing.css"></head>
  ...
  <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse  justify-content-end" id="navbarNav">
          <ul class="navbar-nav">
              ...
              <li class="nav-item">
                  <a class="nav-link" href="bootstrap.login.html">login</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link" href="bootstrap.sign-up.html">sign in</a>
              </li>
              <form class="d-flex">
...
<div class="row grid-layout">
  ...
  <div class="row grid-layout">
  <div class="col-md-2"><img src="doorlocker.jpg" alt="door locker" width="200px" height="200px" class="rounded"></div> 
  ...
  <div class="row grid-layout">
  <div class="col-md-2"><img src="alfa.webp" alt="alfa" width="200px" height="200px" class="rounded"></div>
